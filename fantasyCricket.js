...
var toss = () => {
    ...
    if (randomNumber == 1) {
        ...
        document.getElementById("selectTeam").value = `${player1.toUpperCase()} won the toss`
        // document.getElementById("teamName").innerHTML = `${player1} Create your team<br><br>`
    } else {

        document.getElementById("selectTeam").value = `${player2.toUpperCase()} won the toss`
        gamer = [player2, player1]
        gamingTeam = [player2, player1]
        // document.getElementById("teamName").innerHTML = `${player2} Create your team<br><br>`
    }
    document.getElementById("teamName").innerHTML = `${gamer[0].toUpperCase()} Create your team<br><br>`
...
var summary = () => {
    ...
    if (list1.length + list2.length + list3.length != 11) {
        alert(`11 Players must be selected (${11 - (list1.length + list2.length + list3.length)} remaining)`)
    ...
    filteredArray = players.filter(item1 => !newArr.some(item2 => item2.name === item1.name));
}
var creditData = () => {
...
var secondTeam = () => {
    ...
    document.getElementById("teamName1").innerHTML = `${gamer[1].toUpperCase()} Create your team<br><br>`
}
var bat1 = () => {
    var card = ''
    newArr = [...list1, ...list2, ...list3];
...
var summary1 = () => {
    ...
    if (listTeam1.length + listTeam2.length + listTeam3.length != 11) {
        alert(`11 Players must be selected (${11 - (listTeam1.length + listTeam2.length + listTeam3.length)} remaining)`)
        return false
    }
    // console.log(filteredArray)
...
var teamPreview = () => {
    ...
    document.getElementById("gamingTeam1").innerHTML = `${gamingTeam[0].toUpperCase()} Playing XI`
    document.getElementById("gamingTeam2").innerHTML = `${gamingTeam[1].toUpperCase()} Playing XI`
    let list1 = ''
    let list2 = ''
...
var play = () => {
    ...
    document.getElementById("scoreTeam1").innerHTML = `${gamingTeam[0].toUpperCase()}'s Points`
    document.getElementById("scoreTeam2").innerHTML = `${gamingTeam[1].toUpperCase()}'s Points`
...
var hit = () => {
    ...
    if (currentOver < over && currentBall < ball) {
        ...
        if (playedShot != "Wicket") {
            p += ` <p class="card-text text-center">Over-[${currentOver + 1}.${currentBall + 1}] :  ${myOver[currentOver][currentBall]} , ${new Date().toLocaleString()}  </p>`;
            document.getElementById("batter").value = newArr[bowlerWicket].name;

        } else {
            bowlerWicket++;
            p += ` <p class="card-text text-danger text-center">Over-[${currentOver + 1}.${currentBall + 1}] :  ${myOver[currentOver][currentBall]} , ${new Date().toLocaleString()} `;
            document.getElementById("batter").value = newArr[bowlerWicket].name;
...
var playSecond = () => {
    ...
    document.getElementById("playingTeamPoint1").innerHTML = `${gamingTeam[0].toUpperCase()}'s Points`
    document.getElementById("playingTeamPoint2").innerHTML = `${gamingTeam[1].toUpperCase()}'s Points`
    document.getElementById("showScore").style.display='block'
    document.getElementById("showScoreTeam").innerHTML= `${gamingTeam[0].toUpperCase()}'s Runs`
    document.getElementById("showScoreCard").value=`${runTeam1}/${wicketCount1}`
}
...
var hit1 = () => {
    ...
    document.getElementById("scorecardTeam2").value = `${runTeam2}/${wicketCount2} `;
    if (currentOver1 < over1 && currentBall1 < ball1) {
        ...
        if (playedShot != "Wicket") {
            p += ` <p class="card-text text-center">Over-[${currentOver1 + 1}.${currentBall1 + 1}] :  ${myOver1[currentOver1][currentBall1]} , ${new Date().toLocaleString()}  </p>`;
            document.getElementById("batter1").value = newArr1[bowlerWicket1].name;

        } else {
            bowlerWicket1++;
            p += ` <p class="card-text text-danger text-center">Over-[${currentOver1 + 1}.${currentBall1 + 1}] :  ${myOver1[currentOver1][currentBall1]} , ${new Date().toLocaleString()} `;
            document.getElementById("batter1").value = newArr1[bowlerWicket1].name;
...
var getWinnerName = () => {
    ...
    if (total1 > total2) {
        ...
        document.getElementById("winnerData").innerHTML = `${gamingTeam[0].toUpperCase()} Wins`


    } else {
        console.log(gamingTeam[1].toUpperCase())
        document.getElementById("winnerData").innerHTML = `${gamingTeam[1].toUpperCase()} Wins`
